...
<body>
    <div class="container">
        ...
        <table class="table tbl-1">
            ...
            <tbody>
                <?php if(count($productListView) > 0): ?>
                    <?php $__currentLoopData = $productListView; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                            <img src="imgs/<?php echo e($row->img); ?>" alt="" style="width : 100px">
                            </td>
                            <td>
                                <button class="btn btn-success" type="button">
                                    <a href="/product/edit/<?php echo e($row->id); ?>">Edit</a> </button>
        ...
        <?php echo e($productListView->links()); ?>

    </div>
</body>
<script src="js/demo.js"></script>
</html><?php /**PATH /Volumes/KHAC QUANG/ELEDEVO ACEDEMY/Project Demo/quangdemo1/resources/views/productList.blade.php ENDPATH**/ ?>