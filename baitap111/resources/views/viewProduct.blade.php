    ...
    <div class="container">
        ...
        <form method="post" action="/product/create" enctype="multipart/form-data" class="form-data">
            ...
            <div class="row">
                ...
                <div class="div-content">{{$product->name}}</div>
            </div>
            <div class="row">
                <div class="div-title">Price</div>
                <div class="div-content">{{$product->price}}</div>
            </div>
            <div class="row">
                <div class="div-title">Quantity</div>
                <div class="div-content">{{$product->quantity}}</div>
            </div>
            <div class="row">
                <div class="div-title">Description</div>
                <div class="div-content">{{$product->description}}</div>
            </div>
            <div class="row">
                <div class="div-title">Expired</div>
                <div class="div-content">{{$product->expired}}</div>
            </div>
